...
var Toolbar = /** @class */ (function () {
            ...
            $.each(buttonStr.split(' '), function (i, buttonGroupStr) {
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        isOnlyButtons = false;
                    }else if(buttonName === 'selectDate'){
                    	var selectHtml = '';
                    	var i = 0;
                    	selectHtml +="<span id='fc-dateSelect' class='fc-header-title'>";
                    	selectHtml +="<select name='fcs_date_year' id='fcs_date_year' class='selectable m_year mr15 fcselect'>";
                    	// 循环年份
                    	for(i=2018;i<=2100;i++){        
                    	selectHtml +="<option value='"+i+"'>"+$.trim(i+"年")+"</option>";                        
                    	}
                    	selectHtml +="</select>";
                    	selectHtml +="<select name='fcs_date_month' id='fcs_date_month' class='selectable m_year fcselect'>";
                    	// 循环月份
                    	...
                    	selectHtml +="</select>";
                    	selectHtml +="</span>";
                    	groupChildren = groupChildren.add(selectHtml);
                    	isOnlyButtons = false;
                    }else if(buttonName === 'selectResult'){
                    	var selectHtml = '';
                    	selectHtml +="<span id='fc-resultSelect' class='fc-header-title' style='margin-left:20px'>";
                    	selectHtml +="<select name='fcs_date_result' id='executestate' class='selectable fcselect' style='width: 163px;vertical-align: middle;' onchange='changestate()'>";
                    	selectHtml +="<option value='0'>布控开始</option><option value='1'>布控结束</option>";                        
                    	selectHtml +="</select>";
                    	selectHtml +="</span>";
                    	groupChildren = groupChildren.add(selectHtml);
                    	isOnlyButtons = false;
                    }else if(buttonName === 'selectResult2'){
                    	var selectHtml = '';
                    	selectHtml +="<span id='fc-resultSelect' class='fc-header-title' style='margin-left:20px'>";
                    	selectHtml +="<select name='fcs_date_result' id='executestate' class='selectable fcselect' style='width: 163px;vertical-align: middle;' onchange='changestate()'>";
                    	selectHtml +="<option value='0'>布控结束</option><option value='1'>布控开始</option>";                        
                    	selectHtml +="</select>";
                    	selectHtml +="</span>";
                    	groupChildren = groupChildren.add(selectHtml);
                    	isOnlyButtons = false;
    ...
    Toolbar.prototype.updateTitle = function (text) {
    	if (this.el) {
            ...
            var yeardates=text.split("年")[0];
            var monthdates=text.split("年")[1].split("月")[0];
            $("#fcs_date_year").val(yeardates)
            $("#fcs_date_month").val(monthdates-1)
        }
    };
